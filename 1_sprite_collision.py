...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # If you are animating anytime you change the self.image you would need to create a new mask
...
while True:
    ...
    # Performance wise its better to check collion on the rectangle before you check collision on the mask
